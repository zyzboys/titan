...
do
    ...
    # rocksdb
    rm -rf /users/peiqi714/test/*
    ../rocksdb_6_29/build/db_bench --benchmarks=ycsbfilldb,stats,ycsbwklda,stats  --db=/users/peiqi714/test/db \
                    --statistics=true --ycsb_zipf_const=0.9 --ycsb_readwritepercent=0 --num=$entry_count \
    ...
    # titan
    rm -rf /users/peiqi714/test/*
    ./titandb_bench --benchmarks=ycsbfilldb,stats,ycsbwklda,stats  --db=/users/peiqi714/test/db \
                    --statistics=true --ycsb_zipf_const=0.9 --ycsb_readwritepercent=0 --num=$entry_count \
                    --key_size=16 --value_size=$val_size --compression_type=none \
