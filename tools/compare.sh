...
do
    ...
    ./titandb_bench --benchmarks=ycsbfilldb,stats,ycsbwklda,stats  --db=/users/peiqi714/test/db --threads=$thread_count \
                    --statistics=true --ycsb_zipf_const=0.9 --ycsb_readwritepercent=0 --num=$entry_count --ycsb_num=$ycsb_entry_count \
                    --key_size=16 --value_size=$val_size --compression_type=none --ycsb_warmup_ratio=0.5 \
