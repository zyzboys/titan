...
extern const std::vector<std::string> TitanTickersName = {
    ...
    "titandb.gc.bytes.overwritten.check",
    "titandb.gc.bytes.overwritten.callback",
    "titandb.gc.bytes.relocated",
    "titandb.gc.bytes.fallback",
    "titandb.gc.bytes.written.lsm",
    "titandb.gc.bytes.written.blob",
    "titandb.gc.bytes.read.check",
    "titandb.gc.bytes.read.blob",
    "titandb.gc.bytes.read.callback",
...
const std::vector<std::string> TitanHistogramsName = {
    ...
    "titandb.gc.check.bitset.micros",
    "titandb.gc.check.lsm.micros",
    "titandb.gc.write.micros",
